...
<div class="voucher border">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-6 border" style="font-size: 10px; border-radius: 3px 0px 0px 3px;">
				Username
				<br>
			...
			<div class="col-6 border" style="font-size: 10px; border-radius: 0px 3px 3px 0px;" style="font-size: 13px;">
				Password
				<br>
				<span class="bold" style="font-size: 13px;">
					<?= $password;?>
			...
			<div class="col-12 border bold" style="font-size: 12px;">
				<?php echo $price;?>
				=
				<?php echo $durasi;?> 
			</div>
